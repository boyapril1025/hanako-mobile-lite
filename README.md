...
- **服务器地址**：请在电脑端 Hanako 应用的「设置 → 访问与设备」中查看你自己的地址。首次启动 APP 时可在加载页面点击「修改地址」填入
...
手机需能访问 Hanako 宿主机的地址。通常在同一局域网下即可直接访问；跨局域网使用请自行配置组网或穿透工具。
...
- 首次启动请点击加载页面上的「修改地址」按钮，填入你在电脑端 Hanako 应用「设置 → 访问与设备」中看到的地址
